...
- **Bulk training (manager):** on the Training tab, *Auto-train whole squad* gives every player the most useful key attribute for his position in one click; *Rest everyone* clears all focuses; or tick players (or *Select under-21s*) and apply one focus to all of them.
- **Training in player career:** a Training tab for your own player, with a *Pick the best for me* button, attribute details and PlayStyles.
- **Sell advisor (manager):** when a signing does not fit your wage room or budget, the negotiation offers *Suggest players to sell* (also on the Transfers tab, where you type how much you need). It picks the players with the lowest mix of OVR, potential, game time and average rating, tells you how many and what it frees up, and shows each one's full profile and best offer before you sell. Swap anyone out with *Keep him instead*. After the sale you go straight back to the negotiation.
